      ...
      it "should set default shadow", (done) ->
        stylus("""
               ...
               body
                 ...
                 box-shadow('1px 3px 5px black', '1px 2px')
          ...
          .render (err, css) ->
            (err?).should.be.false
            css = helper.normalizeCss css
            css.should.eql "body { -moz-box-shadow: 0px 0px 5px #333; -webkit-box-shadow: 0px 0px 5px #333; box-shadow: 0px 0px 5px #333; -moz-box-shadow: 1px 3px 5px black, 1px 2px; -webkit-box-shadow: 1px 3px 5px black, 1px 2px; box-shadow: 1px 3px 5px black, 1px 2px; -moz-box-shadow: 0px 0px 5px #333, 1px 2px; -webkit-box-shadow: 0px 0px 5px #333, 1px 2px; box-shadow: 0px 0px 5px #333, 1px 2px; }"
            done();
